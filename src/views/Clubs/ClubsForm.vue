    ...
    <div class="columns">
      <div class="column">
        <b-field label="Username">
          <b-input v-model="username" placeholder="kupotentialclub"></b-input>
        </b-field>
      </div>
      <div class="column">
    ...
    <div class="columns">
      <div class="column">
        <b-field label="Club name">
          <b-input v-model="name" placeholder="KU Pontential Club"></b-input>
        </b-field>
      </div>
      <div class="column">
    ...
    <div class="columns">
      <div class="column">
        <b-field label="Facebook Page">
          <b-input v-model="fbpage" placeholder="KU Potential Club"></b-input>
        </b-field>
      </div>
      <div class="column">
        <b-field label="Instagram">
          <b-input v-model="ig" placeholder="kupotentialclub"></b-input>
        </b-field>
      </div>
    </div>
    <b-field class="file">
