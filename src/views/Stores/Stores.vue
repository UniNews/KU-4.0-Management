  ...
  <div>
    ...
    <card-comp>
      <template v-slot:option>
        <div class="columns">
          <div class="column">
              <button class="button is-success is-fullwidth" @click="addButtonClicked()"><b>CREATE NEW STORE</b></button>  
          </div>
          <div class="column">
            <div class="columns">
              <div class="column">
    ...
    <b-modal :active.sync="isDetailCardModalActive" :width="500" scroll="keep">
      <div class="card">
        <div class="card-content">
          ...
          <div>
            <b>Description</b><span class="marginLeft20px">A yakiniku buffet restaurant</span>
            <hr>
          </div>
          <div>
          ...
          <div>
            <b>Facebook Page</b><span class="marginLeft20px">KU Shabu Buffet</span>
            <hr>
          </div>
